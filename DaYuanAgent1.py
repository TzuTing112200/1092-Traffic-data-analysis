...
#            s.sendall(b'minShengPhase1\r\n')
#            s.sendall(b'minAnPhase1\r\n')
#            s.sendall(b'pingAnPhase1\r\n')
#            s.sendall(b'hengNanPhase1\r\n')
#            s.sendall(b'eastRampPhase1\r\n')
        elif sec==84:
            s.sendall(ERp1Y)
#            s.sendall(b'eastRampPhase1Yellow\r\n')
        elif sec==87:
            s.sendall(ERp1R)
#            s.sendall(b'eastRampPhase1AllRed\r\n')
        elif sec==90:
            s.sendall(ERp2)
#            s.sendall(b'eastRampPhase2\r\n')
        elif sec==94:
            s.sendall(MSp1Y+MAp1Y+PAp1Y+HNp1Y)
#            s.sendall(b'minShengPhase1Yellow\r\nminAnPhase1Yellow\r\npingAnPhase1Yellow\r\nhengNanPhase1Yellow\r\n')
#            s.sendall(b'minShengPhase1Yellow\r\n')
#            s.sendall(b'minAnPhase1Yellow\r\n')
#            s.sendall(b'pingAnPhase1Yellow\r\n')
#            s.sendall(b'hengNanPhase1Yellow\r\n')
        elif sec==97:
            s.sendall(MSp1R+MAp1R+PAp1R+HNp1R)
#            s.sendall(b'minShengPhase1AllRed\r\nminAnPhase1AllRed\r\npingAnPhase1AllRed\r\nhengNanPhase1AllRed\r\n')
#            s.sendall(b'minShengPhase1AllRed\r\n')
#            s.sendall(b'minAnPhase1AllRed\r\n')
#            s.sendall(b'pingAnPhase1AllRed\r\n')
#            s.sendall(b'hengNanPhase1AllRed\r\n')
        elif sec==100:
            s.sendall(MSp2+MAp2+PAp2+HNp2)
#            s.sendall(b'minShengPhase2\r\nminAnPhase2\r\npingAnPhase2\r\nhengNanPhase2\r\n')
#            s.sendall(b'minShengPhase2\r\n')
#            s.sendall(b'minAnPhase2\r\n')
#            s.sendall(b'pingAnPhase2\r\n')
#            s.sendall(b'hengNanPhase2\r\n')
        elif sec==99:
            s.sendall(ERp2Y)
#            s.sendall(b'eastRampPhase2Yellow\r\n')
        elif sec==102:
            s.sendall(ERp2R)
#            s.sendall(b'eastRampPhase2AllRed\r\n')
        elif sec==105:
            s.sendall(ERp3)
#            s.sendall(b'eastRampPhase3\r\n')
        elif sec==118:
            s.sendall(HNp2Y)
#            s.sendall(b'hengNanPhase2Yellow\r\n')
        elif sec==121:
            s.sendall(HNp2R)
#            s.sendall(b'hengNanPhase2AllRed\r\n')
        elif sec==124:
            s.sendall(HNp3)
#            s.sendall(b'hengNanPhase3\r\n')	
        elif sec==129:
            s.sendall(ERp3Y)
#            s.sendall(b'eastRampPhase3Yellow\r\n')
        elif sec==132:
            s.sendall(ERp3R)
#            s.sendall(b'eastRampPhase3AllRed\r\n')
        elif sec==135:
            s.sendall(ERp4)
#            s.sendall(b'eastRampPhase4\r\n')
        elif sec==144:
            s.sendall(MSp2Y+MAp2Y+PAp2Y+HNp3Y+ERp4Y)
#            s.sendall(b'minShengPhase2Yellow\r\nminAnPhase2Yellow\r\npingAnPhase2Yellow\r\nhengNanPhase3Yellow\r\neastRampPhase4Yellow\r\n')
#            s.sendall(b'minShengPhase2Yellow\r\n')
#            s.sendall(b'minAnPhase2Yellow\r\n')
#            s.sendall(b'pingAnPhase2Yellow\r\n')
#            s.sendall(b'hengNanPhase3Yellow\r\n')
#            s.sendall(b'eastRampPhase4Yellow\r\n')
        elif sec==147:
            s.sendall(MSp2R+MAp2R+PAp2R+HNp3R+ERp4R)
#            s.sendall(b'minShengPhase2AllRed\r\nminAnPhase2AllRed\r\npingAnPhase2AllRed\r\nhengNanPhase3AllRed\r\neastRampPhase4AllRed\r\n')
#            s.sendall(b'minShengPhase2AllRed\r\n')
#            s.sendall(b'minAnPhase2AllRed\r\n')
#            s.sendall(b'pingAnPhase2AllRed\r\n')
#            s.sendall(b'hengNanPhase3AllRed\r\n')
#            s.sendall(b'eastRampPhase4AllRed\r\n')
