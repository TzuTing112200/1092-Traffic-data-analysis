...
##                print(data)
                ...
                if noChangeTimes[0] < 3 or noChangeTimes[1] < 3 or noChangeTimes[2] < 3                or noChangeTimes[3] < 3 or noChangeTimes[4] < 3 :
                    ...
                    p = [0, 0, 0, 0, 0]
                    vote = [0, 0]
                    p[0] = random.choices(p1, weights=fw_ms[0])
                    p[1] = random.choices(p1, weights=fw_mn[0])
                    p[2] = random.choices(p1, weights=fw_pg[0])
                    p[3] = random.choices(p2, weights=fw_hn[0])
                    p[4] = random.choices(p3, weights=fw_dz[0])
                ...
                ms_reward -= ms_punish // 10
                mn_reward -= mn_punish // 10
                pg_reward -= pg_punish // 10
                hn_reward -= hn_punish // 10
                dz_reward -= dz_punish // 10
